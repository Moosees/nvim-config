return { -- LSP Configuration & Plugins
  ...
  config = function() -- If you're wondering about lsp vs treesitter, see `:help lsp-vs-treesitter`
    ...
    -- L SP servers and clients are able to communicate to each other what features they support.
